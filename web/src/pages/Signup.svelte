...
<svelte:head>
  <title>Criar conta · Cifra</title>
</svelte:head>

<AuthLayout {site} {flash} title="Novo workspace">
  <form on:submit|preventDefault={submit} class="space-y-3">
    ...
    <button type="submit" class="w-full bg-copper-500 px-4 py-2.5 text-sm font-medium text-ink-950">Criar conta</button>
    <p class="pt-1 text-center text-xs text-paper-200">
      <a href="/login" class="text-copper-400 underline">Já tenho conta</a>
    </p>
  </form>
</AuthLayout>
